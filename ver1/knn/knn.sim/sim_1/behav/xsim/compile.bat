...
REM
REM Generated by Vivado on Tue Feb 03 12:54:33 +0530 2026
...
echo "xvlog --incr --relax -prj tb_knn_vlog.prj"
call xvlog  --incr --relax -prj tb_knn_vlog.prj -log xvlog.log
